package com.kwambi.employeesystem.domain;
...
public class User implements Serializable{
    ...
    private Date lastLoginDate; //new Last login date
    private Date LastLoginDateDisplay; //Last time theu logged in before logging in again
